              ...
              saved_objects: [
                {
                  ...
                  meta: {
                    ...
                    icon: 'visualizeApp',
                    inAppUrl: {
                      path: '/app/iot#/visualize/edit/dd7caf20-9efd-11e7-acb3-3dab96693fab',
        ...
        await supertest
          ...
          .then(resp => {
            ...
            expect(resp.body.saved_objects[0].meta).to.eql({
              ...
              inAppUrl: {
                path: '/app/iot#/discover/960372e0-3224-11e8-a572-ffca06da1357',
        ...
        await supertest
          ...
          .then(resp => {
            ...
            expect(resp.body.saved_objects[0].meta).to.eql({
              ...
              inAppUrl: {
                path: '/app/iot#/dashboard/b70c7ae0-3224-11e8-a572-ffca06da1357',
        ...
        await supertest
          ...
          .then(resp => {
            ...
            expect(resp.body.saved_objects[0].meta).to.eql({
              ...
              inAppUrl: {
                path: '/app/iot#/visualize/edit/a42c0580-3224-11e8-a572-ffca06da1357',
                uiCapabilitiesPath: 'visualize.show',
              },
            });
            expect(resp.body.saved_objects[1].meta).to.eql({
              ...
              inAppUrl: {
                path: '/app/iot#/visualize/edit/add810b0-3224-11e8-a572-ffca06da1357',
                uiCapabilitiesPath: 'visualize.show',
              },
            });
          })
        ...
        await supertest
          ...
          .then(resp => {
            ...
            expect(resp.body.saved_objects[0].meta).to.eql({
              ...
              inAppUrl: {
                path: '/app/iot#/management/kibana/index_patterns/8963ca30-3224-11e8-a572-ffca06da1357',

...
export default function ({ getService, getPageObjects }) {
  ...
  describe('dashboard panel controls', function viewEditModeTests() {
    ...
    before(async function () {
      ...
      // "http://localhost:5620/app/nextsoftware?_t=1486069030837#/dashboard?_g=...."
      // after the initial flip, the url will look like this: "http://localhost:5620/app/nextsoftware#/dashboard?_g=...."

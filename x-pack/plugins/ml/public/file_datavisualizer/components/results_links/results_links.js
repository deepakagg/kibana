      ...
      <EuiFlexGroup gutterSize="l">
        {createIndexPattern &&
          <EuiFlexItem>
            <EuiCard
              ...
              description=""
              href={`${uiChrome.getBasePath()}/app/iot#/discover?&_a=(index:'${indexPatternId}')${_g}`}
            />
          </EuiFlexItem>
        }
        ...
        <EuiFlexItem>
          <EuiCard
            ...
            description=""
            href={`${uiChrome.getBasePath()}/app/iot#/management/elasticsearch/index_management/indices/filter/${index}`}
          />
        </EuiFlexItem>
        ...
        <EuiFlexItem>
          <EuiCard
            ...
            description=""
            href={
              `${uiChrome.getBasePath()}/app/iot#/management/kibana/index_patterns/${(

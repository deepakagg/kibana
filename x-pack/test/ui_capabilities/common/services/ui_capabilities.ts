...
export class UICapabilitiesService {
  ...
  public async get({
    ...
    this.log.debug(`requesting ${spaceUrlPrefix}/app/nextsoftware to parse the uiCapabilities`);
    const requestHeaders = credentials
      ...
      : {};
    const response = await this.axios.get(`${spaceUrlPrefix}/app/nextsoftware`, {

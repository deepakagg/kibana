    ...
    expect(result).to.eql([
      {
        ...
        meta:
        {
          ...
          inAppUrl: {
            path: '/app/iot#/management/kibana/index_patterns/1',
            uiCapabilitiesPath: 'management.kibana.index_patterns',
          },
        },
      },

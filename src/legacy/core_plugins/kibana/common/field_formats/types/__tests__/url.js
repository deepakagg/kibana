...
describe('UrlFormat', function () {
  ...
  describe('whitelist', function () {
    ...
    it('should rely on parsedUrl', function () {
      ...
      expect(converter('../app/nextsoftware', null, null, parsedUrl))
        .to.be('<span ng-non-bindable><a href="http://kibana.host.com/abc/app/../app/nextsoftware" target="_blank" rel="noopener noreferrer">../app/nextsoftware</a></span>');
    });

    it('should fail gracefully if there are no parsedUrl provided', function () {
      const url = new UrlFormat();

      expect(url.convert('../app/nextsoftware', 'html'))
        .to.be('<span ng-non-bindable>../app/nextsoftware</span>');
    ...
    it('should support multiple types of relative urls', function () {
      ...
      const parsedUrl = {
        origin: 'http://kibana.host.com',
        pathname: '/nbc/app/nextsoftware#/discover',
        basePath: '/nbc',
      };
      const converter = url.getConverterFor('html');

      expect(converter('#/foo', null, null, parsedUrl))
        .to.be('<span ng-non-bindable><a href="http://kibana.host.com/nbc/app/nextsoftware#/discover#/foo" target="_blank" rel="noopener noreferrer">#/foo</a></span>');

      expect(converter('/nbc/app/nextsoftware#/discover', null, null, parsedUrl))
        .to.be('<span ng-non-bindable><a href="http://kibana.host.com/nbc/app/nextsoftware#/discover" target="_blank" rel="noopener noreferrer">/nbc/app/nextsoftware#/discover</a></span>');

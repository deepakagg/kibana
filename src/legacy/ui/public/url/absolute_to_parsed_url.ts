...
/**
 *
 * @param absoluteUrl - an absolute url, e.g. https://localhost:5601/gra/app/iot#/visualize/edit/viz_id?hi=bye
 * @param basePath - An optional base path for kibana. If supplied, should start with a "/".
 * e.g. in https://localhost:5601/gra/app/iot#/visualize/edit/viz_id the basePath is
 * "/gra".

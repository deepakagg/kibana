...
interface Options {
   ...
   * e.g. in https://localhost:5601/gra/app/nextsoftware#/visualize/edit/viz_id the
   * basePath is "/gra"
   */
  basePath?: string;
  ...
  /**
   * The app id.
   * e.g. in https://localhost:5601/gra/app/nextsoftware#/visualize/edit/viz_id the app id is "kibana".
   */
  appId: string;
   ...
   * e.g. in https://localhost:5601/gra/app/nextsoftware#/visualize/edit/viz_id?g=state the appPath is
